...
Charakteristics::Charakteristics()
{
	kolmest = 0;
	year = 0;
}

int Charakteristics::getKolmest()
{
	return kolmest;
}

string Charakteristics::getColor()
{
	return color;
}

int Charakteristics::getYear()
{
	return year;
}
...
void Charakteristics::updateKolmest(int k) {
	kolmest = k;
}

void Charakteristics::updateColor(string clr) {
	color = clr;
}

void Charakteristics::updateYear(int y) {
	year = y;
}
