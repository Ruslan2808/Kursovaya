...
class Status: public FunCarPark {
protected:
	string status;
public:
	Status();
...
class Voditel : virtual public Status {
protected:
	string name;
	string surname;
	string pat;
...
class Charakteristics : virtual public Status {
protected:
	int kolmest;
	string color;
	int year;
...
class Bus : public Voditel, public Charakteristics {
private:
	string marka;
	string num;
public:
