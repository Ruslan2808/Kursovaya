...
template<class T> int Interface<T>::menuWorkAccount() {
	...
	while (true) {
		...
		if (ViborPunktaMenu == 1) cout << "->Редактирование данных аккаунтов" << endl;
		else cout << "Редактирование данных аккаунтов" << endl;

		if (ViborPunktaMenu == 2) cout << "->Удаление аккаунтов" << endl;
		else cout << "Удаление аккаунтов" << endl;

		if (ViborPunktaMenu == 3) cout << "->Выход в модуль администратора" << endl;
